...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{uml_classes.png}
    \caption{Diagram klas UML pakietu obliczeń rozmytych i generowania
    podsumowań. Pakiety: \texttt{fuzzy.set} (zbiory i przestrzeń rozważań),
    \texttt{fuzzy.mf} (funkcje przynależności -- delegacja do
...
Poniżej zwięzły opis klas i ich kluczowych metod (rys.~\ref{fig:uml}).
